...
// Source: github.com/figment-networks/oasishub-indexer/repos/stakingseqrepo (interfaces: DbRepo)

// Package mock_stakingseqrepo is a generated GoMock package.
package mock_stakingseqrepo

import (
	stakingseq "github.com/figment-networks/oasishub-indexer/models/stakingseq"
...
func (m *MockDbRepo) Create(arg0 *stakingseq.Model) errors.ApplicationError {
	m.ctrl.T.Helper()
...
func (m *MockDbRepo) GetByHeight(arg0 types.Height) (*stakingseq.Model, errors.ApplicationError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByHeight", arg0)
	ret0, _ := ret[0].(*stakingseq.Model)
