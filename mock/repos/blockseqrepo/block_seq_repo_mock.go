...
// Source: github.com/figment-networks/oasishub-indexer/repos/blockseqrepo (interfaces: DbRepo)

// Package mock_blockseqrepo is a generated GoMock package.
package mock_blockseqrepo

import (
	blockseq "github.com/figment-networks/oasishub-indexer/models/blockseq"
	blockseqrepo "github.com/figment-networks/oasishub-indexer/repos/blockseqrepo"
...
func (m *MockDbRepo) Create(arg0 *blockseq.Model) errors.ApplicationError {
	m.ctrl.T.Helper()
...
// GetAvgBlockTimesForInterval mocks base method
func (m *MockDbRepo) GetAvgBlockTimesForInterval(arg0, arg1 string) ([]blockseqrepo.Row, errors.ApplicationError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAvgBlockTimesForInterval", arg0, arg1)
	ret0, _ := ret[0].([]blockseqrepo.Row)
	ret1, _ := ret[1].(errors.ApplicationError)
	return ret0, ret1
}

// GetAvgBlockTimesForInterval indicates an expected call of GetAvgBlockTimesForInterval
func (mr *MockDbRepoMockRecorder) GetAvgBlockTimesForInterval(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAvgBlockTimesForInterval", reflect.TypeOf((*MockDbRepo)(nil).GetAvgBlockTimesForInterval), arg0, arg1)
}

// GetAvgBlockTimesForRecentBlocks mocks base method
func (m *MockDbRepo) GetAvgBlockTimesForRecentBlocks(arg0 int64) blockseqrepo.Result {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAvgBlockTimesForRecentBlocks", arg0)
	ret0, _ := ret[0].(blockseqrepo.Result)
	return ret0
}

// GetAvgBlockTimesForRecentBlocks indicates an expected call of GetAvgBlockTimesForRecentBlocks
func (mr *MockDbRepoMockRecorder) GetAvgBlockTimesForRecentBlocks(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAvgBlockTimesForRecentBlocks", reflect.TypeOf((*MockDbRepo)(nil).GetAvgBlockTimesForRecentBlocks), arg0)
}

// GetByHeight mocks base method
func (m *MockDbRepo) GetByHeight(arg0 types.Height) (*blockseq.Model, errors.ApplicationError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByHeight", arg0)
	ret0, _ := ret[0].(*blockseq.Model)
	ret1, _ := ret[1].(errors.ApplicationError)
	return ret0, ret1
}
...
func (m *MockDbRepo) GetMostRecent(arg0 blockseqrepo.BlockDbQuery) (*blockseq.Model, errors.ApplicationError) {
	m.ctrl.T.Helper()
...
func (m *MockDbRepo) Save(arg0 *blockseq.Model) errors.ApplicationError {
	m.ctrl.T.Helper()
