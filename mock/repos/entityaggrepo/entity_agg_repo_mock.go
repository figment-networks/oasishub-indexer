...
// Source: github.com/figment-networks/oasishub-indexer/repos/entityaggrepo (interfaces: DbRepo)

// Package mock_entityaggrepo is a generated GoMock package.
package mock_entityaggrepo

import (
	entityagg "github.com/figment-networks/oasishub-indexer/models/entityagg"
...
func (m *MockDbRepo) Create(arg0 *entityagg.Model) errors.ApplicationError {
	m.ctrl.T.Helper()
...
func (m *MockDbRepo) GetByEntityUID(arg0 types.PublicKey) (*entityagg.Model, errors.ApplicationError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByEntityUID", arg0)
	ret0, _ := ret[0].(*entityagg.Model)
	ret1, _ := ret[1].(errors.ApplicationError)
	return ret0, ret1
}
...
func (m *MockDbRepo) Save(arg0 *entityagg.Model) errors.ApplicationError {
	m.ctrl.T.Helper()
