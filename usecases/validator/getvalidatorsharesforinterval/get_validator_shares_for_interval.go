...
type UseCase interface {
	Execute(types.PublicKey, string, string) ([]validatorseqrepo.Row, errors.ApplicationError)
}
...
func (uc *useCase) Execute(key types.PublicKey, interval string, period string) ([]validatorseqrepo.Row, errors.ApplicationError) {
	return uc.validatorSeqDbRepo.GetValidatorSharesForInterval(key, interval, period)
}
